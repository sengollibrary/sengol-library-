/* ===================================================================
   SENGOL LIBRARY — demo data
   NOTE: These are placeholder/demo titles for layout purposes only.
   They are NOT real published books or real authors.
   =================================================================== */
const BOOKS = [
  { id:"b1", title:"The Art of Learning", author:"Demo Author", lang:"English", cat:"Education", price:199 },
  { id:"b2", title:"मेरी कहानी", author:"डेमो लेखक", lang:"Hindi", cat:"Self Growth", price:149 },
  { id:"b3", title:"Build Your First Business", author:"Demo Author", lang:"English", cat:"Business", price:249 },
  { id:"b4", title:"नई शुरुआत", author:"डेमो लेखक", lang:"Hindi", cat:"Fiction", price:129 },
  { id:"b5", title:"Digital India: A Beginner's Guide", author:"Demo Author", lang:"English", cat:"Technology", price:179 },
  { id:"b6", title:"काशी: Stories & Culture", author:"डेमो लेखक", lang:"Hindi", cat:"Culture", price:159 },
  { id:"b7", title:"Mindset for Tomorrow", author:"Demo Author", lang:"English", cat:"Self Growth", price:189 },
  { id:"b8", title:"The Young Entrepreneur", author:"Demo Author", lang:"English", cat:"Business", price:219 },
];
...
function coverStyle(id){
  const idx = parseInt(id.replace("b",""),10) % COVER_STYLES.length;
  return COVER_STYLES[idx];
}
  ...
  document.getElementById("bookModalBody").innerHTML = `
    ...
    <div class="bm-grid">
      ...
      <div>
        ...
        <p>This is a demo listing used to preview the book details layout. A full description, format and preview sample will appear here once real catalogue data is connected.</p>
